...
Y = quantile(theta_list,[0.25 0.50 0.75]);
q1=Y(1);
q2=Y(2);
q3=Y(3);
...
for i =1:size(REC_sorted,1)
    ...
    h2=REC_sorted(i,3)-REC_sorted(i,2);
    rectangle('Position',[i-0.5 REC_sorted(i,2) w h ])
    rectangle('Position',[i-0.5 REC_sorted(i,3) w 0.00001  ],'FaceColor','r')
end
...
rectangle('Position',[0.5 Q1 20 (Q3-Q1)],'EdgeColor','b','LineWidth',1)
rectangle('Position',[0.5 Q2 20 0.00001],'FaceColor',[0 .5 .5])
